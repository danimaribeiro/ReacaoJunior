...
<body>
    ...
    <section id="contact-info">
		<div class="center">
			...
			<p class="lead">Estamos situados no departamento de Química da
					...
					<div class="col-sm-5 text-center">
						<div class="gmap">
							<iframe frameborder="0" scrolling="no" marginheight="0"
								marginwidth="0"
								src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1717.574647245246!2d-48.52252902733174!3d-27.599517194903868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x9c637a721a7a924c!2sDepartamento+de+Qu%C3%ADmica!5e0!3m2!1spt-BR!2sbr!4v1443748688285"></iframe>
						</div>
					</div>
	...
	<section id="contact-page">
		<div class="container">
			<div class="center">
				...
				<p class="lead">Por favor nos envie sua dúvida, entraremos em
					contato com você.</p>
			</div>
					...
					<div class="col-sm-5">
						...
						<div class="form-group">
							<button type="submit" name="submit"
								class="btn btn-primary btn-lg" required="required">Enviar
								Mensagem</button>
						</div>
					</div>
				</form>
